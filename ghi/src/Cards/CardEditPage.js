                    ...
                    { account && account.roles.includes("admin")?
                        <div className="white-space">
                            ...
                            <div className="cardpool margin-top-40" style={{height: "auto"}}>
                                <div className='flex-full margin-top-20'>
                                    <h2 className="ellipsis" style={{margin: "1% 0% 1% 2%", fontWeight: "700"}}>
                                        Add/Remove Card Components
                                    </h2>
                                    { showComps ?
                                ...
                                <div className='space-around media-flex-column-full margin-bottom-20'>
                                    <div className={showComps ? "create-section" : "hidden2"}>
                                        <div>
                                            <h5 className="label">Card Type </h5>
                                            <span className='flex-full'>
                                                <select
                                                    className="builder-input margin-bottom-5"
                                                    type="text"
